...
public class CartController {
    ...
    public ResponseEntity<cartRequest> deleteProductFromCart(@PathVariable Long productId) {

        cartRequest cartRequest = cartService.deleteProductFromCart(productId);
